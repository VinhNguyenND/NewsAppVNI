...
import com.example.myappnews.databinding.AwaitingApprovedAuthorBinding

class Awaiting : Fragment() {
    private lateinit var binding: AwaitingApprovedAuthorBinding;
    ...
    override fun onCreateView(
        ...
        binding = AwaitingApprovedAuthorBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initRcView(context: Context) {
        ...
        _articleAdapter.setClickListener(object : CommonAdapter {
            override fun setOnClickListener(position: Int) {
                ...
                Navigation.findNavController(binding.root).navigate(R.id.editAwait, bundle)
            }
        })
    }
